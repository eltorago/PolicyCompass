...
def parser():
    root = argparse.ArgumentParser(prog="policycompass", description="Compare policy documents with selected frameworks")
    root.add_argument("--version", action="version", version="PolicyCompass " + ENGINE_VERSION)
