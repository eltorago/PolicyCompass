...
TRUST_FILE = Path(__file__).resolve().parent / "assets/trusted-corpus-keys.json"


def installation_root():
    return Path(os.environ.get("LOCALAPPDATA", str(Path.home() / ".local/share"))) / "PolicyCompass/corpus"
